...
const getBaseConfig = require('../webpack/getBaseConfig');
...
module.exports = (
  ...
  // const serverConfig = webpackConfigHooks.server ? webpackConfigHooks.server(config.server) : config.server;
  // const vendorDll = webpackConfigHooks.vendorDll ? webpackConfigHooks.vendorDll(config.vendorDll) : config.vendorDll;
};
